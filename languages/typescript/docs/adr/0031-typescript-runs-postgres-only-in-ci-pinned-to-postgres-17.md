...
(`core/spec/m-dialect.md`), and the pin matches the image the reference
...
`mariadb-curated-25` partial compatibility profile. Cases whose `then.statements`
...
`slice-mvp-1` Postgres profile. MariaDB remains first-class evidence for the database
