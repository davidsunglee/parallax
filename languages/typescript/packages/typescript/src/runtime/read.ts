 ...
 *
 * Since the m-sql → m-dialect inversion the SQL arrives **already locked**: `compile()`
 ...
 * shared row lock (m-read-lock automatic read-lock correctness) and a projection/aggregation
