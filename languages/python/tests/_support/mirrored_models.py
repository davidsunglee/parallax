...
UNMIRRORED: Mapping[str, str] = MappingProxyType(
    {
        ...
        "evolution-crossing-family-v1": _EVOLUTION_ENDPOINT,
        "evolution-crossing-family-v2": _EVOLUTION_ENDPOINT,
        ...
        "evolution-departing-domain-v1": _EVOLUTION_ENDPOINT,
        "evolution-departing-domain-v2": _EVOLUTION_ENDPOINT,
        "evolution-departing-shape-v1": _EVOLUTION_ENDPOINT,
        "evolution-departing-shape-v2": _EVOLUTION_ENDPOINT,
        ...
        "evolution-position-role-v1": _EVOLUTION_ENDPOINT,
        "evolution-position-role-v2": _EVOLUTION_ENDPOINT,
        ...
        "evolution-sealed-domain-v2": _EVOLUTION_ENDPOINT,
        ...
        "classification-transparency-layout-twin-columns": (
            ...
            "its logical model directly with the Document arm"
        ),
        "classification-transparency-layout-twin-document": (
            "no mirror authored; this production descriptor is the Document arm of the "
            "cross-layout stored-data classification proof, and the twin-layout gate compares "
            "its logical model directly with the Columns arm"
        ),
