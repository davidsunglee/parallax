...
class WireTransactionView(WireDatabaseView):
    ...
    write settles against, and publishes its Read activity under the active
    attempt. A Wire write buffers into the same unit of work through the same instruction
