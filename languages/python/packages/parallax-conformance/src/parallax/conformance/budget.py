...
structural read and write windows, derived from the retained baseline capture by
one stated rule and graded by cost-class tests. Both are loaded here and
transcribed nowhere.
"""
