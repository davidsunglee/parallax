...
SKIP_REASONS: Final[dict[str, str]] = {
    ...
    "m-auto-retry": (
        ...
        "retry with the opt-in unset/set, the opt-in inert in locking mode, `maxRetries: 0` "
...
_STREAMED_DELIVERY_REASON: Final[str] = (
    ...
    "page-size invariance over storage the model describes, in BOTH namespaces — is "
...
CASE_SKIP_REASONS: Final[dict[str, str]] = {
    ...
    "m-snapshot-read-038": _STREAMED_DELIVERY_REASON,
    "m-snapshot-read-039": _STREAMED_DELIVERY_REASON,
    "m-snapshot-read-040": _STREAMED_DELIVERY_REASON,
    "m-snapshot-read-041": _STREAMED_DELIVERY_REASON,
    "m-snapshot-read-042": _STREAMED_DELIVERY_REASON,
    "m-snapshot-read-043": _STREAMED_DELIVERY_REASON,
